...
picker.provider('pickerProvider', function () {
  ...
  return {
    ...
    setShortMonthNames: function setShortMonthNames(array) {
    ...
    setStartDate: function setStartDate(param) {
      startDate = param;
    },
    setEndDate: function setEndDate(param) {
      endDate = param;
    },
